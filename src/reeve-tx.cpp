...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Reeve Core reeve-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  reeve-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded reeve transaction") + "\n" +
                               "  reeve-tx [options] -create [commands]   " + _("Create hex-encoded reeve transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded reeve transaction
