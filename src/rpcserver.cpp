...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Reeve features */
        {"reeve", "masternode", &masternode, true, true, false},
        {"reeve", "listmasternodes", &listmasternodes, true, true, false},
        {"reeve", "getmasternodecount", &getmasternodecount, true, true, false},
        {"reeve", "masternodeconnect", &masternodeconnect, true, true, false},
        {"reeve", "masternodecurrent", &masternodecurrent, true, true, false},
        {"reeve", "masternodedebug", &masternodedebug, true, true, false},
        {"reeve", "startmasternode", &startmasternode, true, true, false},
        {"reeve", "createmasternodekey", &createmasternodekey, true, true, false},
        {"reeve", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"reeve", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"reeve", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"reeve", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"reeve", "getmasternodescores", &getmasternodescores, true, true, false},
        {"reeve", "mnbudget", &mnbudget, true, true, false},
        {"reeve", "preparebudget", &preparebudget, true, true, false},
        {"reeve", "submitbudget", &submitbudget, true, true, false},
        {"reeve", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"reeve", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"reeve", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"reeve", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"reeve", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"reeve", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"reeve", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"reeve", "checkbudgets", &checkbudgets, true, true, false},
        {"reeve", "mnsync", &mnsync, true, true, false},
        {"reeve", "spork", &spork, true, true, false},
        {"reeve", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"reeve", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use reeved, or the -server option to reeve-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> reeve-cli " + methodname + " " + args + "\n";
}
