...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x0000010ac9979cdfa92265d9cec10280f3ed0af4fb3c2647b8411cac5b59c123"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1534439909, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 5510;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Reeve starting difficulty is 1 / 2^12
        nSubsidyHalvingInterval = 210000;
        nMaxReorganizationDepth = 100;
        nEnforceBlockUpgradeMajority = 150;
        nRejectBlockOutdatedMajority = 250;
        nToCheckBlockUpgradeMajority = 15;
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Reeve: 1 day
        nTargetSpacing = 1 * 60;  // Reeve: 1 minute
        nMaturity = 10;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Reeve cryptocurrency by Norfolk Team, stable, fast and anonymous";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1534439909;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1029167;
		
		
		hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000010ac9979cdfa92265d9cec10280f3ed0af4fb3c2647b8411cac5b59c123"));
        assert(genesis.hashMerkleRoot == uint256("0x4501311eca168eb8ffe242e6d7fd053fac8873411790c6a82873d467ecb037c9"));
		




vSeeds.push_back(CDNSSeedData("188.225.77.200", "188.225.77.200"));
vSeeds.push_back(CDNSSeedData("188.225.77.197", "188.225.77.197"));
vSeeds.push_back(CDNSSeedData("188.225.77.196", "188.225.77.196"));
        ...
        nStartMasternodePayments = genesis.nTime + 172800; //Wed, 25 Jun 2014 20:36:16 GMT
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet reeve addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet reeve script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet reeve BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet reeve BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet reeve BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Reeve: 1 day
        nTargetSpacing = 1 * 60;        // Reeve: 1 minutes
