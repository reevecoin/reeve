...
/** Utility functions used by the Reeve Qt UI.
 */
namespace GUIUtil
{
...
// Render Reeve addresses in monospace font
...
// Parse "reeve:" URI into recipient object, return true on successful parsing
