...
public:
    ...
    void setZReeveControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzREEVE_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzREEVE_clicked();
    void on_pushButtonZReeveControl_clicked();
