                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Reeve Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Reeve address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and reeve: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zREEVE"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Reeve Core"), this);
    aboutAction->setStatusTip(tr("Show information about Reeve Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Reeve"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Reeve addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Reeve addresses"));
    ...
    openAction->setStatusTip(tr("Open a Reeve: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Reeve Core help message to get a list with possible Reeve command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Reeve Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Reeve network", "", count));
}
...
{
    QString strTitle = tr("Reeve Core"); // default title
