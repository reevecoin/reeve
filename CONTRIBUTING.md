Contributing to Reeve Core
============================

The Reeve Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Reeve Core project, and is not to be
confused with overall Reeve Network Protocol consensus changes.

Whether a pull request is merged into Reeve Core rests with the project merge
...
Patches that change Reeve consensus rules are considerably more involved than
...
Where a patch set proposes to change the Reeve consensus, it must have been
...
The project leader is the release manager for each Reeve Core release.
