...
In order to support loading of multiple wallets in reeve-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is reeve.cpp.
...
Changes to reeve.cpp
----------------------
reeve.cpp is the entry point into reeve-qt, and as such, will require some minor modifications to provide hooks for
