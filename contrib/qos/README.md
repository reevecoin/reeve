...
This means one can have an always-on reeved instance running, and another local reeved/reeve-qt instance which connects to this node and receives blocks from it.
