...
RESOURCES += src/qt/reeve.qrc src/qt/reeve_locale.qrc

TRANSLATIONS += src/qt/locale/reeve_bg.ts \
                src/qt/locale/reeve_de.ts \
                src/qt/locale/reeve_en.ts \
                src/qt/locale/reeve_es.ts \
                src/qt/locale/reeve_fi.ts \
                src/qt/locale/reeve_fr.ts \
                src/qt/locale/reeve_it.ts \
                src/qt/locale/reeve_ja.ts \
                src/qt/locale/reeve_pl.ts \
                src/qt/locale/reeve_pt.ts \
                src/qt/locale/reeve_ru.ts \
                src/qt/locale/reeve_sk.ts \
                src/qt/locale/reeve_sv.ts \
                src/qt/locale/reeve_vi.ts \
                src/qt/locale/reeve_zh_CN.ts \
                src/qt/locale/reeve_zh_TW.ts
